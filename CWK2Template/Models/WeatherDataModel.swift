...
import Foundation
// MARK: - WeatherData
struct WeatherDataModel: Codable, Identifiable, Observable {
    let id = UUID()
    let lat, lon: Double
    let timezone: String
...
enum Description: String, Codable {
    ...
    case lightIntensityDrizzle = "light intensity drizzle" // newly added
